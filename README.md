...
I'm a **BCA (Artificial Intelligence & Machine Learning)** student at **Galgotias University**, building a strong foundation in **Python, Machine Learning, and Database-Driven Software Development**. I enjoy turning raw data and ambiguous problems into structured, working systems — from preprocessing agricultural datasets to training predictive models and shipping database-backed applications.

My focus centers on **Predictive Analytics, Generative AI, and Software Engineering fundamentals** — building projects that combine clean data pipelines, solid database design, and applied ML. I approach every project with curiosity and a bias toward practical, real-world impact.

```yaml
Focus Areas:
  - Machine Learning & Predictive Analytics
  - Python & Database-Driven Application Development
  - Natural Language Processing & Generative AI
  - Software Development Life Cycle (SDLC) Fundamentals
```

**🚀 Open To:**
- Job Openings — **Python Developer** & **Software Development Engineer (SDE)**
- Internship opportunities in Software Development / Machine Learning
- AI & Data Science project collaborations
- Open Source Contributions
- Learning opportunities in Generative AI & LLMs
...
<img src="https://skillicons.dev/icons?i=django,mysql,sqlite&theme=dark" />
...
|---|:---:|---|
| **Machine Learning** | ⭐⭐⭐⭐☆ | Model training, evaluation, and feature engineering using Scikit-learn |
| **Data Preprocessing & EDA** | ⭐⭐⭐⭐☆ | Data cleaning, exploratory data analysis using Pandas & NumPy |
| **NLP** | ⭐⭐⭐☆☆ | Intent classification and chatbot development using NLTK & TensorFlow/Keras |
| **Predictive Analytics** | ⭐⭐⭐⭐☆ | Building ML-based prediction models with visualization using Matplotlib |
| **Database Systems** | ⭐⭐⭐⭐☆ | Relational database design and management using MySQL & SQLite |
| **Generative AI** | ⭐⭐⭐☆☆ | Actively exploring LLMs and Generative AI applications |
...
| **Scale** | Trained and evaluated on multi-feature agricultural datasets |
| **Performance** | Optimized through feature engineering and model evaluation |
| **Security** | Local data handling with clean preprocessing pipelines |
| **Impact** | Demonstrates end-to-end applied ML workflow for real-world prediction tasks |
| **Repository** | [Add repo link] |

Focused on turning noisy agricultural data into a reliable predictive signal — cleaning and engineering features, comparing model performance, and visualizing results to make the predictions interpretable.
...
| **Scale** | Manages structured records across students, attendance, and academics |
| **Performance** | Efficient SQL queries for CRUD and record retrieval |
| **Security** | Structured input handling and relational data integrity |
| **Impact** | Streamlines academic record-keeping through a centralized system |
| **Repository** | [Add repo link] |

Designed around clean relational database structure, with SQL queries handling create, read, update, and delete operations across student records, attendance, and academic history.
...
| **Scale** | Handles account creation, transactions, and balance management |
| **Performance** | OOP-driven design for maintainable transaction logic |
| **Security** | Input validation to prevent invalid transactions and data errors |
| **Impact** | Simulates real-world banking operations with reliable data persistence |
| **Repository** | [Add repo link] |

Built using Object-Oriented Programming principles to model accounts and transactions cleanly, with SQLite handling persistent storage and input validation guarding against invalid operations.
...
| Category | Details |
|---|---|
| **Stack** | Python, NLTK, TensorFlow/Keras, Streamlit |
| **Scale** | Trained on intent-labeled query data for classification |
| **Performance** | Intent classification model for relevant response matching |
| **Security** | Local inference with a self-contained interface |
| **Impact** | Demonstrates applied NLP for conversational interfaces |
| **Repository** | [Add repo link] |

Combines NLTK-based text processing with a TensorFlow/Keras intent classification model, wrapped in a Streamlit interface for real-time interactive conversations.
...
Building a strong academic foundation in AI/ML, database systems, and software development, backed by hands-on project work.
...
`Python` `SQL` `Machine Learning` `DBMS` `OOP` `Data Preprocessing`
...
<img src="https://raw.githubusercontent.com/Tanushree860/Tanushree860/output/github-contribution-grid-snake-dark.svg" width="90%"/>
...
Building:
  - AI and software projects combining ML, Python, and databases
...
Open To:
  - Job Openings: Python Developer & SDE
  - Internship Opportunities in Software Development / Machine Learning
